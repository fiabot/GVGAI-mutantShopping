...
public class Test {
	public static void createFrame() {
		...
		RunGame runnable1 = new RunGame(game1, level1, visuals, sampleRHEAController, recordActionsFile, seed, 0, panel,
				frame);
		RunGame runnable2 = new RunGame(game2, level2, visuals, sampleRHEAController, recordActionsFile2, 42, 0, panel,
				frame);
		Thread thread1 = new Thread(runnable1);
		Thread thread2 = new Thread(runnable2);

		RunGame runnable3 = new RunGame(game3, level3, visuals, sampleRHEAController, recordActionsFile, seed, 0, panel,
				frame);
		RunGame runnable4 = new RunGame(game4, level4, visuals, sampleRHEAController, recordActionsFile2, 42, 0, panel,
				frame);
	...
	public static void testPlayView() {
		...
		GameGridDisplay grid = new GameGridDisplay(game_list, levels, sampleOLETSController, frame.getContentPane(),
				frame, seed);
		/*
		 * GamePlayView view1 = new GamePlayView(game1, level1, sampleOLETSController,
		 * panel, grid);
		 * GamePlayView view2 = new GamePlayView(game2, level2, sampleOLETSController,
		 * panel, grid);
		 * GamePlayView view3 = new GamePlayView(game3, level3, sampleOLETSController,
		 * panel, grid);
		 * GamePlayView view4 = new GamePlayView(game4, level4, sampleOLETSController,
		 * panel, grid);
		 */
	...
	public static void simpleGame() {
		...
		GameGridDisplay grid = new GameGridDisplay(game_list, levels, sampleRSController, frame.getContentPane(), frame,
				seed);
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * // 2. This plays a game in a level by the controller.
		 * ArcadeMachine.runOneGame(game, level1, visuals, sampleRHEAController,
		...
		// ArcadeMachine.runGames(game, new String[]{level1}, M, sampleMCTSController,
		// null);
		// }
		...
		// ".txt";
		// }
		// ArcadeMachine.runGames(game, levels, M, sampleRHEAController, saveActions?
		// actionFiles:null);
		// }
